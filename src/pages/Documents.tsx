...
const TEMPLATE_CONTENT: Record<string, string> = {
    ...
    exp_letter: `[PROF_HEADER]\n<div style="text-align:center; margin-bottom: 40px;"><h2 style="font-size: 22pt; text-decoration: underline; font-weight: 900; letter-spacing: 2px;">EXPERIENCE / SERVICE CERTIFICATE</h2></div>\n\n<p style="font-size: 14pt; line-height: 2; text-align: justify;">This is to certify that <b>[NAME]</b> S/O [PARENT_NAME] has served at this institution as <b>[DESIGNATION]</b> from <b>[JOIN_DATE]</b> to <b>[LEAVE_DATE]</b>.</p>\n\n<p style="font-size: 14pt; line-height: 2; text-align: justify;">During his/her tenure, we found him/her to be hardworking, dedicated, and professional. He/she always discharged his/her duties to the entire satisfaction of the management. We wish him/her the best of luck in future endeavors.</p>\n\n<div style="margin-top: 80px; display: flex; justify-content: space-between; font-weight: bold;">\n  <div>Date: __________</div>\n  <div>Director/Principal: ____________________</div>\n</div>\n[PROF_FOOTER]`,
    char_cert: `[PROF_HEADER]\n<div style="text-align:center; margin-bottom: 50px;"><h1 style="font-size: 28pt; font-family: 'Cinzel', serif; font-weight: 900; text-decoration: underline; color: #003366;">CHARACTER CERTIFICATE</h1></div>\n\n<p style="font-size: 16pt; line-height: 2.2; text-align: justify;">Certified that <b>[STUDENT_NAME]</b> Son/Daughter of <b>[PARENT_NAME]</b> resident of <b>[ADDRESS]</b> has been a regular and bonafide student of this institution in <b>Class [CLASS]</b> under Admission No <b><u>[ID]</u></b>.</p>\n\n<p style="font-size: 16pt; line-height: 2.2; text-align: justify;">During his/her stay at the campus, he/she displayed good moral values. His/her conduct and character remained <b><u>EXCELLENT</u></b>. He/she bears a good moral character.</p>\n\n<div style="margin-top: 100px; display: flex; justify-content: space-between; font-size: 14pt;">\n  <div><b>Date of Issue:</b> __________</div>\n  <div style="text-align: center;">____________________<br/><b>Principal</b></div>\n</div>\n[PROF_FOOTER]`,
    slc: `[PROF_HEADER]\n<div style="text-align:center; margin-bottom: 40px; padding: 10px; border: 2px solid #003366; display: inline-block; border-radius: 10px;"><h1 style="font-size: 24pt; margin: 0; color: #003366; font-family: 'Cinzel', serif;">SCHOOL LEAVING CERTIFICATE</h1></div>\n\n<p style="font-size: 15pt; line-height: 2.2; text-align: justify;">This is to certify that <b>[STUDENT_NAME]</b> Son/Daughter of <b>[PARENT_NAME]</b> was a bonafide student of this institution from <b><u>[JOIN_DATE]</u></b> to <b><u>[LEAVE_DATE]</u></b>.</p>\n\n<p style="font-size: 15pt; line-height: 2.2; text-align: justify;">He/She has successfully completed the course for <b>Class [CLASS]</b> examination. All dues up to the date of leaving have been fully paid. We wish him/her success in all future educational pursuits.</p>\n\n<div style="margin-top: 100px; display: flex; justify-content: space-between; font-size: 14pt;">\n  <div style="text-align: center;">____________________<br/><b>Clerk / Admin</b></div>\n  <div style="text-align: center;">____________________<br/><b>Principal</b></div>\n</div>\n[PROF_FOOTER]`,
    appreciation: `<div style="text-align:center; padding: 60px 40px; border: 15px double #003366; margin: 20px; background-color: #fdfbf7; position: relative;">\n<div style="position: absolute; inset: 0; opacity: 0.05; background-image: url('https://www.transparenttextures.com/patterns/cubes.png');"></div>\n<h1 style="font-size: 40pt; font-family: 'Cinzel', serif; color: #b45309; margin-bottom: 10px; font-weight: 900;">CERTIFICATE OF APPRECIATION</h1>\n<div style="width: 100px; height: 3px; background: #b45309; margin: 20px auto;"></div>\n<p style="font-size: 16pt; margin-top: 30px; font-style: italic;">This certificate is proudly presented to</p>\n<h2 style="font-size: 36pt; color: #003366; margin: 20px 0; font-family: 'Great Vibes', 'Cinzel', serif; border-bottom: 2px dashed #ccc; display: inline-block; padding-bottom: 5px; min-width: 60%;">[STUDENT_NAME]</h2>\n<p style="font-size: 14pt; max-width: 80%; margin: 30px auto; line-height: 1.8;">In recognition of your outstanding performance, dedication, and excellence in <b>[ACTIVITY]</b>. Your commitment to maintaining high standards is truly inspiring to your peers.</p>\n<div style="margin-top: 80px; display: flex; justify-content: space-between; padding: 0 50px; font-weight: bold; font-size: 14pt;">\n  <div style="text-align: center; border-top: 2px solid #333; padding-top: 10px; width: 200px;">Date: [DATE]</div>\n  <div style="text-align: center; border-top: 2px solid #333; padding-top: 10px; width: 200px;">Principal Signature</div>\n</div>\n</div>`,
    achievement: `<div style="text-align:center; background: linear-gradient(135deg, #fffcf0 0%, #fff 100%); padding: 60px; border: 20px solid #d4af37; outline: 3px solid #003366; outline-offset: -25px; position: relative;">\n<div style="position: absolute; top: 30px; left: 30px; right: 30px; bottom: 30px; border: 1px solid #d4af37; pointer-events: none;"></div>\n<h1 style="font-size: 45pt; color: #003366; font-family: 'Cinzel', serif; margin-bottom: 0;">AWARD OF ACHIEVEMENT</h1>\n<h3 style="color: #d4af37; margin-top: 5px; letter-spacing: 5px;">EXCELLENCE AWARD</h3>\n<p style="font-size: 16pt; margin-top: 40px; font-style: italic;">Proudly Awarded to</p>\n<h2 style="font-size: 38pt; color: #333; margin: 20px 0; border-bottom: 2px solid #d4af37; display: inline-block; padding: 0 40px 10px;">[NAME]</h2>\n<p style="font-size: 16pt; line-height: 1.8; max-width: 700px; margin: 30px auto;">For achieving the <b>[POSITION]</b> position in the <b>[EVENT]</b> held on [DATE]. Your hard work and perseverance are highly appreciated.</p>\n<div style="margin-top: 80px; text-align: right; padding-right: 50px; font-size: 14pt;">\n  <div style="display: inline-block; text-align: center; border-top: 2px solid #333; padding-top: 10px; width: 250px;"><b>Principal</b></div>\n</div>\n</div>`,
    noc: `[PROF_HEADER]\n<div style="text-align:center; margin-bottom: 40px;"><h2 style="font-size: 22pt; text-decoration: underline; font-weight: 900; letter-spacing: 2px;">NO OBJECTION CERTIFICATE (NOC)</h2></div>\n\n<p style="font-size: 15pt; line-height: 2.2; text-align: justify;">This is to certify that <b>[STUDENT_NAME]</b> Son/Daughter of <b>[PARENT_NAME]</b> is a regular and bonafide student of Class <b>[CLASS]</b> in our institution.</p>\n\n<p style="font-size: 15pt; line-height: 2.2; text-align: justify;">The school has <b>NO OBJECTION</b> if the student seeks admission in any other institution due to <b>[REASON]</b>.</p>\n\n<p style="font-size: 15pt; line-height: 2.2; text-align: justify;">It is further certified that all school dues have been cleared up to <b>[MONTH]</b>.</p>\n\n<div style="margin-top: 80px; display: flex; justify-content: space-between; font-weight: bold;">\n  <div>Date: __________</div>\n  <div>Principal: ____________________</div>\n</div>\n[PROF_FOOTER]`,
